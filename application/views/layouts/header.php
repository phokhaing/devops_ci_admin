...
<!-- Mirrored from coderthemes.com/ubold/layouts/purple/apps-tickets.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jul 2019 09:49:05 GMT -->
<head>
        <meta charset="utf-8" />
        <title> App | <?php echo (isset($title) ? ucfirst($title) : ucfirst($this->uri->segment(2))); ?></title>
